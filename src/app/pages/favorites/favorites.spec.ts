/*
  Archivo de pruebas unitarias del componente de la página de favoritos (Favorites)
  Este archivo contiene las pruebas para el componente Favorites
...
/*
  Suite de pruebas para el componente Favorites
...
describe('Favorites', () => {
  ...
  beforeEach(async () => {
    // Configura el módulo de testing con el componente Favorites
    // TestBed.configureTestingModule() crea un módulo de testing
    await TestBed.configureTestingModule({
      imports: [Favorites] // Importa el componente Favorites
    })
  ...
  /*
    Prueba: Debe crear el componente Favorites
