/*
  Archivo de pruebas unitarias del componente de la página de búsqueda (Search)
  Este archivo contiene las pruebas para el componente Search
...
// Importa el componente Search que se va a probar
import { Search } from './search';

/*
  Suite de pruebas para el componente Search
  describe() define un grupo de pruebas relacionadas
  Parámetros:
  1. Nombre de la suite: 'Search'
...
describe('Search', () => {
  ...
  beforeEach(async () => {
    // Configura el módulo de testing con el componente Search
    // TestBed.configureTestingModule() crea un módulo de testing
    await TestBed.configureTestingModule({
      imports: [Search] // Importa el componente Search
    })
  ...
  /*
    Prueba: Debe crear el componente Search
